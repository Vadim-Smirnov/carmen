...
public class NumberPicker extends LinearLayout implements OnClickListener,
        OnFocusChangeListener, OnLongClickListener, View.OnTouchListener {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mText = (EditText) findViewById(R.id.number_picker_input);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (Math.abs(coordinateY - event.getY()) > 10) {
                    if (coordinateY > event.getY()) {
                            mIncrementButton.callOnClick();
                    } else if (coordinateY < event.getY()) {
                            mDecrementButton.callOnClick();
                    }
                }
        }
        return false;
