...
public class RecyclerListHorizontalItemDecorator extends RecyclerView.ItemDecoration {

    private int mItemSpacing;

    public RecyclerListHorizontalItemDecorator(Context context, @DimenRes int itemSpacing) {
